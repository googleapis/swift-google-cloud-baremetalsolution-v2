...
public struct CreateProvisioningConfigRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateProvisioningConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateProvisioningConfigRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.baremetalsolution.v2.CreateProvisioningConfigRequest"
  }
