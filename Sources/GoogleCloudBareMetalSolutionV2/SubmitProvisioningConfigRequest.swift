...
public struct SubmitProvisioningConfigRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SubmitProvisioningConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SubmitProvisioningConfigRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.baremetalsolution.v2.SubmitProvisioningConfigRequest"
  }
