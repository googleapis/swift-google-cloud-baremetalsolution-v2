...
public struct ListLunsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of luns.
  public var luns: [Lun] = []
  ...
  /// Initialize a new instance of `ListLunsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLunsResponse().with { $0.luns = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.baremetalsolution.v2.ListLunsResponse"
  }
...
extension ListLunsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Lun] {
    return self.luns
  }
