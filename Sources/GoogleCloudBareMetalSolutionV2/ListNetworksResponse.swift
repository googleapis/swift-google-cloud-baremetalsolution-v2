...
public struct ListNetworksResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListNetworksResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListNetworksResponse().with { $0.networks = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.baremetalsolution.v2.ListNetworksResponse"
  }
...
extension ListNetworksResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Network] {
