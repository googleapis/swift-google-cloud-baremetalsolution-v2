...
public struct ListVolumeSnapshotsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListVolumeSnapshotsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListVolumeSnapshotsResponse().with { $0.volumeSnapshots = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let volumeSnapshots = CodingKeys(stringValue: "volumeSnapshots")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.baremetalsolution.v2.ListVolumeSnapshotsResponse"
  }
...
extension ListVolumeSnapshotsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [VolumeSnapshot] {
    return self.volumeSnapshots
  }
