...
public struct ListVolumesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListVolumesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListVolumesResponse().with { $0.volumes = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.baremetalsolution.v2.ListVolumesResponse"
  }
...
extension ListVolumesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Volume] {
    return self.volumes
  }
