...
public struct ListOSImagesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListOSImagesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListOSImagesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.baremetalsolution.v2.ListOSImagesRequest"
  }
